...
// Simulator of PDA accepting words NOT in {a^nb^n | n >= 0}
// The input alphabet is {a, b}.
// The stack alphabet is {$, a}.

#include <stdio.h> // For 'printf'
#include <stdlib.h> // For 'malloc', 'free', EXIT_SUCCESS, etc.
#include <string.h> // For 'strcmp' to check for cmd options
#include <stack> // stack data structure

using namespace std;

// Global variable (set only once, in 'main')
